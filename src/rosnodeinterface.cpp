  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"oneshotadder\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(oneshotadder_M, (NULL));
        oneshotadder_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(oneshotadder_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(oneshotadder_M)
                == (NULL)) || rtmGetStopRequested(oneshotadder_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(oneshotadder_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
